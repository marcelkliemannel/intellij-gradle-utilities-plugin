...
abstract class OpenWebsiteAction(linkTitle: String, private val url: String) :
  ...
  class GradleUserManual :
    OpenWebsiteAction(
      "Gradle User Manual",
      "https://docs.gradle.org/current/userguide/userguide.html",
    )

  class GradleUserManualCommandLineInterface :
    OpenWebsiteAction(
      "User Manual: Command Line Interface",
      "https://docs.gradle.org/current/userguide/command_line_interface.html",
    )

  class GradleUserManualGroovyDslReference :
    OpenWebsiteAction(
      "User Manual: Groovy DSL Reference",
      "https://docs.gradle.org/current/dsl/index.html",
    )

  class GradleReleaseNotes :
    OpenWebsiteAction("Gradle Release Notes", "https://docs.gradle.org/current/release-notes.html")
